                            ...
                            <?php foreach ($fields['first_block']['infographics'] as $part) : ?>
                                <div class="about-page__doctor-info_icon-block">
                                    <div class="about-page__doctor-info_icon-wrap">
                                        <div class="about-page__doctor-info_icon"
                            ...
                            <div class="surgery-results__left">
                                ...
                                <div class="surgery-results__list">
                                    <div class="surgery-results__item">
                                        <a href="./procedure-page.html" class="surgery-results__link"
                                           href="./procedure-page.html"
                                           style="background-image: url('./dist/images/surgery-results/nose.jpg')">
                                            <span class="surgery-results__link-text">Нос</span>
                                        </a>
                                    </div>
                                    <div class="surgery-results__item">
                                        <a href="./procedure-page.html" class="surgery-results__link"
                                           style="background-image: url('./dist/images/surgery-results/breast.jpg')">
                                            <span class="surgery-results__link-text">Грудь</span>
                                        </a>
                                    </div>
                                    <div class="surgery-results__item">
                                        <a href="./procedure-page.html" class="surgery-results__link"
                                           style="background-image: url('./dist/images/surgery-results/body.jpg')">
                                            <span class="surgery-results__link-text">Тело</span>
                                        </a>
                                    </div>
                                    <div class="surgery-results__item">
                                        <a href="./procedure-page.html" class="surgery-results__link"
                                           style="background-image: url('./dist/images/surgery-results/face.jpg')">
                                            <span class="surgery-results__link-text">Лицо</span>
                                        </a>
                                    </div>
                                    <div class="surgery-results__item">
                                        <a href="./procedure-page.html" class="surgery-results__link"
                                           style="background-image: url('./dist/images/surgery-results/aesthetic_medicine.jpg')">
                                            <span class="surgery-results__link-text">Эстетическая медицина</span>
                                        </a>
                                    </div>
                                    <div class="surgery-results__item">
                                        <a href="./procedure-page.html" class="surgery-results__link"
                                           style="background-image: url('./dist/images/surgery-results/intimate_plastic.jpg')">
                                ...
                                <div class="surgery-results__wrap-slider">
                                    <div id="surgeryResultsSliderAbout" class="surgery-results__slider">
                                        <div class="surgery-results__slider-item">
                                            <div class="surgery-results__img"
                                                 style="background-image: url('./dist/images/surgery-results/img1.jpg')"></div>
                                        </div>
                                        <div class="surgery-results__slider-item">
                                            <div class="surgery-results__img"
                                                 style="background-image: url('./dist/images/surgery-results/img2.jpg')"></div>
                                        </div>
                                        <div class="surgery-results__slider-item">
                                            <div class="surgery-results__img"
                                                 style="background-image: url('./dist/images/surgery-results/img3.jpg')"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
