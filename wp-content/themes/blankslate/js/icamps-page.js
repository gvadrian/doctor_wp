...
(function () {
  $(document).ready(function () {
    ...
    if (icampsSlider.length) {
      ...
      if (wViewport[0] > 1200) {
        icampsDeskSlider.slick(icampsDeskSliderSettings); // addSlideDesk(icampsPhotoGallery[0]);
        ...
        $('.icamps-photos__link').click(function () {
          ...
          icampsDeskSlider.slick('unslick'); // /* Clear element content */
      ...
      if (wViewport[0] >= 1 && wViewport[0] < 1200) {
        icampsMobSlider.slick(icampsMobSliderSettings); // addSlideMob(icampsPhotoGallery[0]);
        ...
        $('.icamps-photos__link').click(function () {
          ...
          icampsMobSlider.slick('unslick'); // /* Clear element content */
