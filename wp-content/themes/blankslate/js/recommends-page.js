...
(function () {
  $(document).ready(function () {
    ...
    $(function () {
      ...
      $('.gallery').slick(galleryPreviewSettings);
      $('.gallery2').slick(galleryVideoSettings);
      ...
      $('.doctor-recommends__nav-link').click(function () {
        ...
        $('.gallery2').slick('unslick'); // /* Clear element content */
