...
(function () {
    ...
    $(document).ready(function () {
         ...
         // /* Youtube Popup */
        $('.headerVideoPlayButton').YouTubePopUp({ autoplay: 0});
        

        $('#expertSmmSliderMain').slick({
            dots: false,
            arrows: true,
            dragable: false,
            slidesToShow: 4,
        ...
        // /* Slick surgery results  */

        $('#surgeryResultsSliderMain').slick({
            dots: true,
            arrows: true,
            vertical: false,
            dragable: false,
        ...
        $('#surgeryResultsSliderMain').slickLightbox({
            itemSelector: 'a.surgery-results__img'
        });

         /* Recommends slider settings */
        ...
        function addSlide(slides) {
            ...
            slides.forEach(function (slide) {
                $('#recommendsSliderPreviewsMain').slick('slickAdd',
                    ` <div>
                ...
                $('#recommendsSliderVideosMain').slick('slickAdd',
                    `<div>
        ...
        /* Recommends slider initialization */
        $(function () {

            $('#recommendsSliderPreviewsMain').slick(galleryPreviewSettings);
            $('#recommendsSliderVideosMain').slick(galleryVideoSettings);

            addSlide(galleryCollection);
            $(".inlinePlayButton:not(.headerVideoPlayButton)").YouTubePopUp({ autoplay: 0 });
            

            /* sync preview with video */
            $("#recommendsSliderPreviewsMain .slick-slide").on("click", function () {
                var index = $(this).attr("data-slick-index");
                $('#recommendsSliderVideosMain').slick("slickGoTo", index);
            });
        })
